...
<body style="background-color: #333;">
    <div class="topnav">
        ...
        <a class="btn" href="#books" onclick="onButtonClick(this)"><i class="fas fa-book"></i></i> Books</a>
        ...
        <a class="active" href="users.php" onclick="onButtonClick(this)"><i class="fas fa-user"></i> Users</a>
